...
$config['admin_email']                = defined('SMTP_USER') ? SMTP_USER : 'admin@localhost';
...
$config['lockout_time']               = 360;                 // The number of seconds to lockout an account due to exceeded attempts/
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['email_templates'] = 'auth'.DIRECTORY_SEPARATOR;

$config['email_activate'] = 'activate.tpl.php';

$config['email_forgot_password'] = 'lostpass.tpl.php';

$config['email_forgot_password_complete'] = 'newpass.tpl.php';
