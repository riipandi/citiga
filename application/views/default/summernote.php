...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=site_url('assets/summernote/summernote.css'); ?>" />
</head>
<body>
	<div id="container">
		<h1>Summernote with elFinder <span style="float:right">Aris Ripandi</span></h1>
		<div id="body">
	...
	<script src="<?=site_url('assets/summernote/summernote.min.js'); ?>"></script>
	<script src="<?=site_url('assets/summernote/plugin/ext-elfinder.js'); ?>"></script>
	...
	$(function() {
		...
		height: 200,
		tabsize: 2,
		toolbar: [['style', ['bold', 'italic', 'underline', 'clear']], ['insert', ['elfinder']] ]
		});
	});
