...
<html>
	<head>
		...
		<style>
			...
			h1{font-weight:lighter;letter-spacing:.8px;font-size:3rem;margin-top:80px;margin-bottom:0;color:#222}
			.wrap{max-width:1024px;margin:2rem auto;padding:2rem;background:#fff;text-align:center;border:1px solid #efefef;border-radius:.5rem;position:relative}
			.version{margin-top:10px;color:#999}
			.guide{margin-top:3rem;text-align:left}
			...
			p{margin-top:1.5rem} .text-center {text-align: center;}
			.footer{margin-top:2rem;border-top:1px solid #efefef;padding:1em 2em 0;font-size:85%;color:#999}
			a:active,a:link,a:visited{color:#dd4814;text-decoration:none}
		</style>
	</head>
	<body>
		<div class="wrap">
			...
			<div class="guide">
				...
				<p>
					...
					<a href="//codeigniter.com/user_guide/" target="_new">User Guide</a>.</p>
			</div>
			<div class="footer">
