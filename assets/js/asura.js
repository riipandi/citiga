...
* @version 2.4.2
* @repository git://github.com/riipandi/asura.git
...
$(document).keydown(function (event) {
    if ((event.ctrlKey || event.metaKey) && event.shiftKey && event.which == 76) {
        console.log('Logout using CTRL_Shift_L');
        setTimeout('window.location.href = "signout";', 100);
        event.preventDefault();
        return false;
    };
});
...
$(document).ready(function () {
    ...
    $("#login-form").validate({
        rules: {
            identity: { required: true, minlength: 4, email: false },
